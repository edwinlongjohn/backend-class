...
! function () {
    ...
    function B(t, e, n) {
        ...
        return o && i ? o.query(e, i, n)().abort : (n(void 0, 424), H)
    }
    const G = "iconify2",
        V = "iconify",
        K = V + "-count",
    ...
    function nt(t, e) {
        return tt(t, K, e.toString())
    }

    function ot(t) {
        return parseInt(Z(t, K)) || 0
    }
    const it = {
            local: !0,
            session: !0
    ...
    let st = !1;
    let ct = "undefined" == typeof window ? {} : window;

    function at(t) {
        const e = t + "Storage";
        try {
            if (ct && ct[e] && "number" == typeof ct[e].length) return ct[e]
        } catch (t) {}
        it[t] = !1
    }
    ...
    function ut(t, e) {
        ...
        if (o !== G) {
            if (o) {
                const t = ot(n);
                for (let e = 0; e < t; e++) et(n, V + e.toString())
            }
            return tt(n, W, G), void nt(n, 0)
        }
        const i = Math.floor(Date.now() / X) - Y,
            r = t => {
        ...
        let s = ot(n);
        for (let e = s - 1; e >= 0; e--) r(e) || (e === s - 1 ? (s--, nt(n, s)) : rt[t].add(e))
    }

    function lt() {
        if (!st) {
            st = !0;
            for (const t in it) ut(t, (t => {
                const e = t.data,
    ...
    function ft(t, e) {
        function n(n) {
            ...
            else if (r = ot(o), !nt(o, r + 1)) return;
            const s = {
                cached: Math.floor(Date.now() / X),
                provider: t.provider,
                data: e
            };
            return tt(o, V + r.toString(), JSON.stringify(s))
        }
        st || lt(), e.lastModified && ! function (t, e) {
            const n = t.lastModifiedCached;
            if (n && n >= e) return n === e;
            if (t.lastModifiedCached = e, n)
                for (const n in it) ut(n, (n => {
                    const o = n.data;
    ...
    const pt = (t, e) => {
            ...
            if (!o.pending.length) {
                let t = !0;
                return e && setTimeout((() => {
                    t && e(o.loaded, o.missing, o.pending, dt)
                })), () => {
                    t = !1
                }
            }
    ...
    function Tt(t, e) {
        let n = Array.from(t.childNodes).find((t => t.hasAttribute && t.hasAttribute(It)));
        n || (n = document.createElement("style"), n.setAttribute(It, It), t.appendChild(n)), n.textContent = ":host{display:inline-block;vertical-align:" + (e ? "-0.125em" : "0") + "}span,svg{display:block}" + Et
    }
    ...
    function Dt(t, e) {
        ...
        if ("svg" === s) c = function (t) {
            ...
            const i = Ft(t.body, n);
            return e.innerHTML = qt(i), e.firstChild
        }(r);
            ...
            r = class extends n {
                ...
                attributeChangedCallback(t) {
                    if ("inline" === t) {
                        const t = bt(this),
                            e = this._state;
                        t !== e.inline && (e.inline = t, Tt(this._shadowRoot, t))
                ...
                _iconChanged(t) {
                    ...
                    e.data ? this._gotIconData(e) : this._state = Ut(e, this._state.inline, this._state)
                }
                _gotIconData(t) {
                ...
                _renderIcon(t, e, n) {
                    ...
                    Dt(this._shadowRoot, this._state = {
                        rendered: !0,
                        icon: t,
                        inline: i,
                        customisations: e,
