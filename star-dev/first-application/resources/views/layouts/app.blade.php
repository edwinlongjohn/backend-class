...
<body>
                ...
                <div class="d-flex align-items-center">
                            ...
                            <div class="dropdown-menu p-0 dropdown-menu-end dropdown-menu-lg"
                                ...
                                <div class="notification-body position-relative z-2 rounded-0" data-simplebar>
                                    ...
                                    <div class="dropdown-item notification-item py-3 text-wrap border-bottom"
                                        ...
                                        <div class="d-flex">
                                            <div class="me-2 position-relative flex-shrink-0">
                                                <img src="/admin_assets/img/doctors/doctor-01.jpg"
                                    ...
                                    <div class="dropdown-item notification-item py-3 text-wrap border-bottom"
                                        ...
                                        <div class="d-flex">
                                            <div class="me-2 position-relative flex-shrink-0">
                                                <img src="/admin_assets/img/doctors/doctor-06.jpg"
                                                    class="avatar-md rounded-circle" alt="">
                                            </div>
                                            <div class="flex-grow-1">
                                    ...
                                    <div class="dropdown-item notification-item py-3 text-wrap border-bottom"
                                        ...
                                        <div class="d-flex">
                                            <div class="me-2 position-relative flex-shrink-0">
                                                <img src="/admin_assets/img/doctors/doctor-02.jpg"
                                                    class="avatar-md rounded-circle" alt="">
                                            </div>
                                            <div class="flex-grow-1">
                                    ...
                                    <div class="dropdown-item notification-item py-3 text-wrap" id="notification-4">
                                        <div class="d-flex">
                                            <div class="me-2 position-relative flex-shrink-0">
                                                <img src="/admin_assets/img/doctors/doctor-07.jpg"
                                                    class="avatar-md rounded-circle" alt="">
                                            </div>
                                            <div class="flex-grow-1">
                    ...
                    <div class="dropdown profile-dropdown d-flex align-items-center justify-content-center">
                        <a href="javascript:void(0);"
                            ...
                            <img src="/admin_assets/img/users/user-01.jpg" width="32" class="rounded-circle d-flex"
                                alt="user-image">
                        ...
                        <div class="dropdown-menu dropdown-menu-end dropdown-menu-md p-2">
                            ...
                            <div class="d-flex align-items-center bg-light rounded-3 p-2 mb-2">
                                <img src="/admin_assets/img/users/user-01.jpg" class="rounded-circle" width="42"
                                    height="42" alt="">
                                <div class="ms-2">
    ...
    <script defer
        ...
        data-cf-beacon='{"rayId":"96b11f485bbfb884","version":"2025.7.0","serverTiming":{"name":{"cfExtPri":true,"cfEdge":true,"cfOrigin":true,"cfL4":true,"cfSpeedBrain":true,"cfCacheStatus":true}},"token":"3ca157e612a14eccbb30cf6db6691c29","b":1}'
