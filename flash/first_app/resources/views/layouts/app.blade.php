...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="/admin_assets/img/favicon.png">

    <!-- Apple Icon -->
    <link rel="apple-touch-icon" href="/admin_assets/img/apple-icon.png">

    <!-- Theme Config Js -->
    <script src="/admin_assets/js/theme-script.js" type="66b99f0a61a7ed7b0988539a-text/javascript"></script>

    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="/admin_assets/css/bootstrap.min.css">
     <!-- Quill CSS -->
    <link rel="stylesheet" href="/admin_assets/plugins/quill/quill.snow.css">

    <!-- Bootstrap Tagsinput CSS -->
    <link rel="stylesheet" href="/admin_assets/plugins/bootstrap-tagsinput/bootstrap-tagsinput.css">
 ...
 <!-- Select2 CSS -->
    ...
    <!-- Tabler Icon CSS -->
    <link rel="stylesheet" href="/admin_assets/plugins/tabler-icons/tabler-icons.min.css">

    <!-- Simplebar CSS -->
    <link rel="stylesheet" href="/admin_assets/plugins/simplebar/simplebar.min.css">

    <!-- Main CSS -->
    <link rel="stylesheet" href="/admin_assets/css/style.css" id="app-style">
...
<body>
                ...
                <div class="d-flex align-items-center gap-2">
                    ...
                    <a href="index.html" class="logo">
                        ...
                        <span class="logo-light">
                            <span class="logo-lg"><img src="/admin_assets/img/logo.svg" alt="logo"></span>
                            <span class="logo-sm"><img src="/admin_assets/img/logo-small.svg" alt="small logo"></span>
                        </span>

                        <!-- Logo Dark -->
                        <span class="logo-dark">
                            <span class="logo-lg"><img src="/admin_assets/img/logo-white.svg" alt="dark logo"></span>
                        </span>
                    </a>
                ...
                <div class="d-flex align-items-center">
							...
							<div class="dropdown-menu p-0 dropdown-menu-end dropdown-menu-lg" style="min-height: 300px;">
								...
								<div class="notification-body position-relative z-2 rounded-0" data-simplebar>
									...
									<div class="dropdown-item notification-item py-3 text-wrap border-bottom" id="notification-1">
										<div class="d-flex">
											<div class="me-2 position-relative flex-shrink-0">
												<img src="/admin_assets/img/doctors/doctor-01.jpg" class="avatar-md rounded-circle" alt="">
											</div>
									...
									<div class="dropdown-item notification-item py-3 text-wrap border-bottom" id="notification-2">
										<div class="d-flex">
											<div class="me-2 position-relative flex-shrink-0">
												<img src="/admin_assets/img/doctors/doctor-06.jpg" class="avatar-md rounded-circle" alt="">
											</div>
											<div class="flex-grow-1">
									...
									<div class="dropdown-item notification-item py-3 text-wrap border-bottom" id="notification-3">
										<div class="d-flex">
											<div class="me-2 position-relative flex-shrink-0">
												<img src="/admin_assets/img/doctors/doctor-02.jpg" class="avatar-md rounded-circle" alt="">
											</div>
											<div class="flex-grow-1">
									...
									<div class="dropdown-item notification-item py-3 text-wrap" id="notification-4">
										<div class="d-flex">
											<div class="me-2 position-relative flex-shrink-0">
												<img src="/admin_assets/img/doctors/doctor-07.jpg" class="avatar-md rounded-circle" alt="">
											</div>
											<div class="flex-grow-1">
					...
					<div class="dropdown profile-dropdown d-flex align-items-center justify-content-center">
                        <a href="javascript:void(0);" class="topbar-link dropdown-toggle drop-arrow-none position-relative" data-bs-toggle="dropdown" data-bs-offset="0,22" aria-haspopup="false" aria-expanded="false">
                            <img src="/admin_assets/img/users/user-01.jpg" width="32" class="rounded-circle d-flex" alt="user-image">
                        ...
                        <div class="dropdown-menu dropdown-menu-end dropdown-menu-md p-2">
                            ...
                            <div class="d-flex align-items-center bg-light rounded-3 p-2 mb-2">
                                <img src="/admin_assets/img/users/user-01.jpg" class="rounded-circle" width="42" height="42" alt="">
                                <div class="ms-2">
            ...
            <div class="sidebar-logo">
                <div>
                    ...
                    <a href="index.html" class="logo logo-normal">
                        <img src="/admin_assets/img/logo.svg" alt="Logo">
                    </a>

                    <!-- Logo Small -->
                    <a href="index.html" class="logo-small">
                        <img src="/admin_assets/img/logo-small.svg" alt="Logo">
                    </a>

                    <!-- Logo Dark -->
                    <a href="index.html" class="dark-logo">
                        <img src="/admin_assets/img/logo-white.svg" alt="Logo">
                    </a>
                </div>
                        ...
                        <li>
                            <ul>
                                ...
                                <li class="submenu">
                                    ...
                                    <ul>
                                        <li><a href="{{route('posts.create')}}">Add Blog</a></li>
                ...
                <div class="sidebar-footer border-top mt-3">
                    <div class="trial-item mt-0 p-3 text-center">
                        <div class="trial-item-icon rounded-4 mb-3 p-2 text-center shadow-sm d-inline-flex">
                            <img src="/admin_assets/img/icons/sidebar-icon.svg" alt="img">
                        </div>
                        <div>
    ...
    <!-- jQuery -->
    <script src="/admin_assets/js/jquery-3.7.1.min.js" type="text/javascript"></script>

    <!-- Bootstrap Core JS -->
    <script src="/admin_assets/js/bootstrap.bundle.min.js" type="text/javascript"></script>

	<!-- Simplebar JS -->
	<script src="/admin_assets/plugins/simplebar/simplebar.min.js" type="text/javascript"></script>

    <!-- Chart JS -->
    <script src="/admin_assets/plugins/apexchart/apexcharts.min.js" type="text/javascript"></script>
    <script src="/admin_assets/plugins/apexchart/chart-data.js" type="text/javascript"></script>
<!-- Select2 JS -->
    <script src="/admin_assets/plugins/select2/js/select2.min.js" type="text/javascript"></script>
	<!-- Daterangepikcer JS -->
	<script src="/admin_assets/js/moment.min.js" type="text/javascript"></script>
	<script src="/admin_assets/plugins/daterangepicker/daterangepicker.js" type="text/javascript"></script>
	<script src="/admin_assets/js/bootstrap-datetimepicker.min.js" type="text/javascript"></script>
     <!-- Quill JS -->
    <script src="/admin_assets/plugins/quill/quill.min.js" type="text/javascript"></script>

    <!-- Bootstrap Tagsinput JS -->
    <script src="/admin_assets/plugins/bootstrap-tagsinput/bootstrap-tagsinput.js" type="text/javascript"></script>
    <!-- Main JS -->
    <script src="/admin_assets/js/script.js" type="text/javascript"></script>
